...
namespace DNNGo.Modules.ThemePlugin
{
	...
	public partial class DNNGo_ThemePlugin_MenuOptions : Entity<DNNGo_ThemePlugin_MenuOptions>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个菜单参数表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static DNNGo_ThemePlugin_MenuOptions FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_ThemePlugin_MenuOptions entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_ThemePlugin_MenuOptions();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_ThemePlugin_MenuOptions FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_ThemePlugin_MenuOptions> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
