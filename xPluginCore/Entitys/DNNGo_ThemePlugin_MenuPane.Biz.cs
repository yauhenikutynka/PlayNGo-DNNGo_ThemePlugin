...
namespace DNNGo.Modules.ThemePlugin
{
	...
	public partial class DNNGo_ThemePlugin_MenuPane : Entity<DNNGo_ThemePlugin_MenuPane>
	{
		...
		#region 扩展属性
            ...
            /// Pane中保存的行
            /// </summary>
            public List<DNNGo_ThemePlugin_MenuRowItem> Rows
        {
            get;
            set;
        }
        ...
        #region 扩展查询
        /// <summary>
        /// 根据主键查询一个菜单容器实体对象用于表单编辑
        /// </summary>
        ///<param name="__ID">编号</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
		public static DNNGo_ThemePlugin_MenuPane FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_ThemePlugin_MenuPane entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_ThemePlugin_MenuPane();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_ThemePlugin_MenuPane FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_ThemePlugin_MenuPane> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// </summary>
        /// <returns></returns>
        public static List<DNNGo_ThemePlugin_MenuPane> FindAllByTabID(Int32 TabID)
        {
            Int32 RecordCount = 0;
