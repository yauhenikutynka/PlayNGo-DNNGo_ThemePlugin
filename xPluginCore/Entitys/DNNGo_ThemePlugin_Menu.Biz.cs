...
namespace DNNGo.Modules.ThemePlugin
{
	...
	public partial class DNNGo_ThemePlugin_Menu : Entity<DNNGo_ThemePlugin_Menu>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个菜单内容表实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static DNNGo_ThemePlugin_Menu FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_ThemePlugin_Menu entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_ThemePlugin_Menu();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_ThemePlugin_Menu FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_ThemePlugin_Menu> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
