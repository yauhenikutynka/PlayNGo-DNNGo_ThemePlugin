...
{
    public partial class Skin_Html : BaseNavObjectBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                /* 2012-09-27  这里是一个定制项，需求来自于曹沃*/
                if (StandardMenu)
                {
                    //LoadScript("StandardMenu.js");
        ...
        public string ViewMenuBind(List<TabInfo> tabs)
        {
            ...
            sb.AppendFormat("<ul  class=\"{0}\">", StandardMenu ? "sf-menu sf-js-enabled" : "");
             ...
             if (ChildLevel <= MaxLevel || MaxLevel <= 0)
             {
                 ...
                 for (int i = 0; i < tabs.Count; i++)
                 {
                     if (tabs[i].ParentId == ParentId)
                     {
                         ...
                         str.AppendFormat("<li class=\"{0} {1} {2} SunItem-{3}\">", dirClass, ActiveClass, CircularBeadStyle, itemIndex);
