<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_Manager.aspx.cs" Inherits="DNNGo.Modules.ThemePlugin.Index_Manager" %>
...
<script type="text/javascript">
    jQuery(function (q) {
        ...
        $('.color-picker-auto').colorpicker({ format: 'hex' }).on("change", function () {
