...
{
    public partial class Resource_GalleryImage : BaseModule
    {
        ...
        public String CurrentUrl
        {
            get
            {
                ...
                sb.AppendFormat("{0}?PortalId={1}&TabId={2}&ModuleId={3}&language={4}", "Resource_GalleryImage.aspx", PortalId, TabId, ModuleId, language);
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            Where.Add(new SearchParam(DNNGo_ThemePlugin_Multimedia._.FileExtension, "'jpg','jpeg','gif','png','bmp'", SearchType.In));
