...
(function (q) {
        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = q.extend({
                    ...
                    formData: {},                 // An object with Add data to send to the server-side upload script with every file upload
                ...
                if (swfUploadOptions) {
                    swfUploadSettings = q.extend(swfUploadSettings, swfUploadOptions);
                }
                // Add the user-defined settings to the swfupload object
                swfUploadSettings = q.extend(swfUploadSettings, settings);
                ...
                if (flashInstalled) {
                    ...
                    q('#' + swfuploadify.movieName).wrap($wrapper);
                    // Recreate the reference to wrapper
                    $wrapper = q('#' + settings.id);
                    ...
                    var $button = q('<div />', {
                        ...
                        'class': 'uploadify-button btn-primary' + settings.buttonClass
                    });
            ...
            this.each(function () {
                ...
                if (args[0]) {
                    ...
                    if (args[0] == '*') {
                        ...
                        q('#' + settings.queueID).find('.uploadify-queue-item').each(function () {
                            delay++;
                            if (args[1] === true) {
                                swfuploadify.cancelUpload(q(this).attr('id'), false);
                            } else {
                                swfuploadify.cancelUpload(q(this).attr('id'));
                            }
                            q(this).find('.data').removeClass('data').html(' - Cancelled');
                            q(this).find('.uploadify-progress-bar').remove();
                            q(this).delay(1000 + 100 * delay).fadeOut(500, function () {
                                q(this).remove();
                            });
                        });
                        ...
                        for (var n = 0; n < args.length; n++) {
                            ...
                            q('#' + args[n]).find('.data').removeClass('data').html(' - Cancelled');
                            q('#' + args[n]).find('.uploadify-progress-bar').remove();
                            q('#' + args[n]).delay(1000 + 100 * n).fadeOut(500, function () {
                                q(this).remove();
                            });
                        }
                    }
                } else {
                    var item = q('#' + settings.queueID).find('.uploadify-queue-item').get(0);
                    $item = q(item);
        ...
        destroy: function () {
            ...
            this.each(function () {
                ...
                if (settings.defaultQueue) {
                    q('#' + settings.queueID).remove();
                }

                // Reload the original DOM element
                q('#' + settings.id).replaceWith(swfuploadify.original);
            ...
            this.each(function () {
                ...
                if (args.length === 1) {
                    ...
                    switch (name) {
                        ...
                        case 'formData':
                            if (!resetObjects) {
                                value = q.extend(settings.formData, value);
                            }
                        ...
                        case 'buttonCursor':
                            ...
                            break;
                        case 'buttonText':
                            q('#' + settings.id + '-button').find('.uploadify-button-text').html(value);
                            break;
                        case 'width':
    ...
    var handlers = {
        ...
        onDialogClose: function (filesSelected, filesQueued, queueLength) {
            ...
            if (q.inArray('onDialogClose', settings.overrideEvents) < 0) {
            ...
            if (settings.auto) q('#' + settings.id).uploadify('upload', '*');
        },
        ...
        onSelect: function (file) {
            ...
            // Run the default event handler
            if (q.inArray('onSelect', settings.overrideEvents) < 0) {

                // Add the file item to the queue
                q('#' + settings.queueID).append('<div id="' + file.id + '" class="uploadify-queue-item">\
					<div class="cancel">\
        ...
        onSelectError: function (file, errorCode, errorMsg) {
            ...
            // Run the default event handler
            if (q.inArray('onSelectError', settings.overrideEvents) < 0) {
                switch (errorCode) {
        ...
        onUploadComplete: function (file) {
            ...
            if (q.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                        ...
                        case SWFUpload.FILE_STATUS.COMPLETE:
                            setTimeout(function () {
                                if (q('#' + file.id)) {
                                    ...
                                    q('#' + file.id).fadeOut(500, function () {
                                        q(this).remove();
                                    });
                                }
        ...
        onUploadError: function (file, errorCode, errorMsg) {
            ...
            switch (errorCode) {
                ...
                case SWFUpload.UPLOAD_ERROR.FILE_CANCELLED:
                    ...
                    this.queueData.queueSize -= file.size;
                    if (file.status == SWFUpload.FILE_STATUS.IN_PROGRESS || q.inArray(file.id, this.queueData.uploadQueue) >= 0) {
            ...
            // Call the default event handler
            if (q.inArray('onUploadError', settings.overrideEvents) < 0) {

                if (errorCode != SWFUpload.UPLOAD_ERROR.FILE_CANCELLED && errorCode != SWFUpload.UPLOAD_ERROR.UPLOAD_STOPPED) {
                    q('#' + file.id).addClass('uploadify-error');
                }

                // Reset the progress bar
                q('#' + file.id).find('.uploadify-progress-bar').css('width', '1px');

                // Add the error message to the queue item
                if (errorCode != SWFUpload.UPLOAD_ERROR.SPECIFIED_FILE_ID_NOT_FOUND && file.status != SWFUpload.FILE_STATUS.COMPLETE) {
                    q('#' + file.id).find('.data').html(' - ' + errorString);
                }
            }
        ...
        onUploadProgress: function (file, fileBytesLoaded, fileTotalBytes) {
            ...
            // Call the default event handler
            if (q.inArray('onUploadProgress', settings.overrideEvents) < 0) {
                if (settings.progressData == 'percentage') {
                    q('#' + file.id).find('.data').html(' - ' + percentage + '%');
                } else if (settings.progressData == 'speed' && lapsedTime > 500) {
                    q('#' + file.id).find('.data').html(' - ' + this.queueData.averageSpeed + suffix);
                }
                q('#' + file.id).find('.uploadify-progress-bar').css('width', percentage + '%');
            }
        ...
        onUploadSuccess: function (file, data, response) {
            ...
            // Call the default event handler
            if (q.inArray('onUploadSuccess', settings.overrideEvents) < 0) {
                q('#' + file.id).find('.data').html(' - Complete');
            }
    ...
    q.fn.uploadify = function (method) {
        ...
        if (methods[method]) {
            ...
            q.error('The method ' + method + ' does not exist in q.uploadify');
        }
